    ...
    <>
      <div className="lg:grid lg:grid-cols-2 lg:h-[calc(100vh-90px)] items-start justify-between home flex flex-col-reverse mt-5 lg:mt-0 gap-4 lg:gap-10">
        ...
        {/* <div className="absolute flex gap-3 bottom-3 left-1/2 transform -translate-x-1/2 transition-all cursor-pointer z-50 text-xl ">
          <a href="https://www.instagram.com/amitazadi/" target="_blank">
            <BsInstagram className="hover:scale-125 transition-all" />
          </a>
          <a href="https://github.com/amitazadi" target="_blank">
            <BsGithub className="hover:scale-125 transition-all" />
          </a>
          <a href="https://www.linkedin.com/in/amitazadi/" target="_blank">
